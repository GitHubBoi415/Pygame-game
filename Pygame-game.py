...
clock_img = pygame.image.load(resource_path('Clock.png')).convert_alpha()
dice_img = pygame.image.load(resource_path('Dice.png')).convert_alpha()
heal_img = pygame.image.load(resource_path('Heal.png')).convert_alpha()
skull_img = pygame.image.load(resource_path('Skull.png')).convert_alpha()
disabled_img = pygame.image.load(resource_path('Disabled.png')).convert_alpha()
reset_img = pygame.image.load(resource_path('Reset.png')).convert_alpha()
sawblade_img = pygame.image.load(resource_path('Sawblade.png')).convert_alpha()
end_tutorial_button = pygame.image.load(resource_path('End Tutorial Button.png')).convert_alpha()
end_tutorial_button_2 = pygame.image.load(resource_path('End Tutorial Button Hovered Over.png')).convert_alpha()
intro_tutorial_screen = pygame.image.load(resource_path('Intro Tutorial Screen.png')).convert_alpha()
death_screen = pygame.image.load(resource_path('Death Screen.png')).convert_alpha()
return_to_main_menu = pygame.image.load(resource_path('Return to Main Menu.png')).convert_alpha()
...
cymbal_sfx = pygame.mixer.Sound(resource_path('crash cymbal.wav'))
glug_sfx = pygame.mixer.Sound(resource_path('glug.wav'))
crunch_sfx = pygame.mixer.Sound(resource_path('crunch.wav'))
